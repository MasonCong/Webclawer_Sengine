...
public class PSucker implements MessageReceiver {
	...
	public PSucker(Queue q, int maxLevel, int maxThreads, String filenamePrefix)
		throws InstantiationException, IllegalAccessException {
		PSuckerThread.prefix=filenamePrefix;
	...
	public static void main(String argss[]) {
		String args[] = {"http://www.usnews.com/", "com/File", "10","1000","10"};
		...
		try {
			...
			if (args.length >= 2) {
				...
				new PSucker(q, maxLevel, maxThreads, args[1]);
				return;
			}
		} catch (Exception e) {
