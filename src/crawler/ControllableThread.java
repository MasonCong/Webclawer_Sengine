...
abstract public class ControllableThread extends Thread{
	...
	public void run(){
		...
		for(Object newTask = queue.pop(level);
				...
				//Tell the message receiver what we'are doing now
				mr.receiveMessage(newTask, id);
				//Process the newTask
				process(newTask, tc.counter);
				//If there are less threads running than it count, try
	 ...
	 */
	public abstract void process(Object o, int c);
